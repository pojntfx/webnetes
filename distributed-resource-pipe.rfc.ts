...
enum EResourcePipeResourceTypes {
  PROCESS = "webnetes.felix.pojtinger.com/v1alpha1/process",
  TERMINAL = "webnetes.felix.pojtinger.com/v1alpha1/terminal",
}

enum EPeerPipeResourceTypes {
  STDOUT = "webnetes.felix.pojtinger.com/v1alpha1/stdout",
  STDIN = "webnetes.felix.pojtinger.com/v1alpha1/stdin",
}
