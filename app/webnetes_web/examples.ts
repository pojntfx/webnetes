...
export const exampleGoEchoServerResourcesToCreate = `apiVersion: webnetes.felix.pojtinger.com/v1alpha1
kind: Runtime
metadata:
  name: Go JSSI
  label: jssi_go
...
export const exampleGoEchoClientResourcesToCreate = `apiVersion: webnetes.felix.pojtinger.com/v1alpha1
kind: Runtime
metadata:
  name: Go JSSI
  label: jssi_go
...
export const exampleCEchoServerResourcesToCreate = `apiVersion: webnetes.felix.pojtinger.com/v1alpha1
kind: Runtime
metadata:
  name: Generic WASI
  label: wasi_generic
...
export const exampleCEchoClientResourcesToCreate = `apiVersion: webnetes.felix.pojtinger.com/v1alpha1
kind: Runtime
metadata:
  name: Generic WASI
  label: wasi_generic
...
export const exampleTinyGoEchoServerResourcesToCreate = `apiVersion: webnetes.felix.pojtinger.com/v1alpha1
kind: Runtime
metadata:
  name: TinyGo WASI
  label: wasi_tinygo
...
export const exampleTinyGoEchoClientResourcesToCreate = `apiVersion: webnetes.felix.pojtinger.com/v1alpha1
kind: Runtime
metadata:
  name: TinyGo WASI
  label: wasi_tinygo
...
export const exampleGoEchoClientResourcesToCreateFragment = `apiVersion: webnetes.felix.pojtinger.com/v1alpha1
kind: Capability
metadata:
  name: Connecting to aliases
  label: connect_to_alias
...
kind: Processor
metadata:
  name: Felix's iPhone 2
  label: felixs_iphone_2
spec:
  runtimes:
    - jssi_go
  capabilities:
...
export const exampleCEchoClientResourcesToCreateFragment = `apiVersion: webnetes.felix.pojtinger.com/v1alpha1
kind: Capability
metadata:
  name: Connecting to aliases
  label: connect_to_alias
...
export const exampleTinyGoEchoClientResourcesToCreateFragment = `apiVersion: webnetes.felix.pojtinger.com/v1alpha1
kind: Capability
metadata:
  name: Connecting to aliases
  label: connect_to_alias
