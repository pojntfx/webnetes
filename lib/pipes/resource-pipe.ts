...
export enum EResourcePipeTypes {
  ...
  PROCESS_WRITE_TO_STDIN = "webnetes.felix.pojtinger.com/v1alpha1/resources/processWriteToStdin",
  TERMINAL_WRITE_TO_STDOUT = "webnetes.felix.pojtinger.com/v1alpha1/resources/terminalWriteToStdout",
  CREATE_WORKLOAD = "webnetes.felix.pojtinger.com/v1alpha1/resources/createWorkload",
  PROCESS_READ_FROM_STDOUT = "webnetes.felix.pojtinger.com/v1alpha1/resources/processReadFromStdout",
  TERMINAL_READ_FROM_STDIN = "webnetes.felix.pojtinger.com/v1alpha1/resources/terminalReadFromStdin",
  INPUT_DEVICE_INSTANCE = "webnetes.felix.pojtinger.com/v1alpha1/resources/inputDeviceInstance",
  CREATE_INPUT_DEVICE = "webnetes.felix.pojtinger.com/v1alpha1/resources/createInputDevice",
}
